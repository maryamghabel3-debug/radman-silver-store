...
def render_report(
    ...
    *,
    ...
    lines: List[str] = [
        ...
        "- **ساختار نهایی تأییدشده مالک:** ID بالاتر یعنی محصول جدیدتر؛ ID پایین‌تر یعنی محصول قدیمی‌تر.",
        "- این گزارش دو سر بازه را برای کنترل چشمی نشان می‌دهد؛ انتخاب importer جدید با `ID DESC` انجام می‌شود.",
        "",
        "## ۱) توزیع دسته‌ها",
        "",
    ...
    lines.extend(
        [
            ...
            "",
            "### ۵ ID پایین‌تر — قدیمی‌ترین‌ها",
            "",
            *_product_table(analysis["lowest_id_products"]),
            "",
            "### ۵ ID بالاتر — جدیدترین‌ها",
            "",
    ...
    for key, heading in (
        ("lowest_1000", "۱۰۰۰ محصول با ID پایین‌تر — قدیمی‌تر"),
        ("highest_1000", "۱۰۰۰ محصول با ID بالاتر — جدیدتر"),
    ):
        window = analysis[key]
        lines.extend(
            [
    ...
    lines.extend(
        [
            ...
            "## تصمیم لازم از مالک",
            "",
            "1. پنج محصول ID پایین و پنج محصول ID بالا را با سایت قدیمی مقایسه و ساختار تأییدشده «ID بالاتر = جدیدتر» را کنترل کند.",
