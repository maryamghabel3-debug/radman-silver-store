# PR-33 — توضیحات عمومی پاک و مشخصات بدون prefix زائد
...
PR-33 متن داخلی/سیستمی انتهای description را کاملاً حذف می‌کند؛ description verified مستقیماً با آخرین bullet، معمولاً `کد مدل`، تمام می‌شود. prefixهای زائد `انگشتر:`, `دستبند:` و `گردنبند:` نیز پیش از validation از مقدار specification حذف می‌شوند.
