...
- **Exact Product Pricing (PR-34):** legacy/Excel price is preserved exactly when it is above the verified weight floor; otherwise the exact floor wins. Only non-integral Toman results are ceiled to the next whole Toman. No psychological, 9-ending, or 50000-Toman rounding is applied.
...
- **Original-Product Pipeline Status:** PR-34 applies exact-Toman pricing without 50000/charm rounding and adds deterministic Rank Math-compatible product SEO plus a Draft-only publication quality gate. PR-33/PR-32 content, identity, and contamination safeguards remain active.
...
- [docs/LEGACY-API-ACCESS-STRATEGY.md](docs/LEGACY-API-ACCESS-STRATEGY.md) — Historical/deferred API strategy; not used by the PR-34 owner runner.
...
- [docs/PRODUCT-SEO-AND-AI-VISIBILITY-RUNBOOK.md](docs/PRODUCT-SEO-AND-AI-VISIBILITY-RUNBOOK.md) / [docs/PRODUCT-SEO-QUALITY-GATE.md](docs/PRODUCT-SEO-QUALITY-GATE.md) / [docs/SEO-TOPIC-MAP-CONTRACT.md](docs/SEO-TOPIC-MAP-CONTRACT.md) — PR-34 exact repricing, deterministic product SEO, publication blockers, and the future research-agent contract.
- [docs/HTML-SPEC-ENRICHMENT-RUNBOOK.md](docs/HTML-SPEC-ENRICHMENT-RUNBOOK.md) / [scripts/run_excel_import.sh](scripts/run_excel_import.sh) — Clean public descriptions, normalized spec values, strict validation safeguards, and guarded Draft-only modes.
