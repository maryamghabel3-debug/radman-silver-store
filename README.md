...
- [docs/EXCEL-1000-PRODUCT-IMPORT-RUNBOOK.md](docs/EXCEL-1000-PRODUCT-IMPORT-RUNBOOK.md) / [scripts/run_excel_import.sh](scripts/run_excel_import.sh) — Definitive Excel-driven newest-1000 selection, ID-only gallery discovery, gemstone-aware Toman pricing, private reports, and guarded create-only Draft import.
