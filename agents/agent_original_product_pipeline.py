...
"""
    ...
    def create_legacy_draft(
        ...
        metadata = {
            ...
            "price_locked": "1",
            "price_rounding_policy": "EXACT_NO_CHARM_NO_50000_ROUNDING",
            ...
            "radman_legacy_price_exact_toman": str(pricing.get("legacy_price_toman") or ""),
            "radman_computed_floor_exact_toman": str(pricing.get("calculated_raw_toman") or ""),
            "radman_final_price_exact_toman": str(pricing["final_price_toman"]),
