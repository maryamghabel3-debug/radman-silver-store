...
- Price kept strictly in Product/Offer schema (read from _regular_price), omitted from <meta description>
- Unverified adjectives (e.g. 'طبیعی' where not in stone spec) strictly purged
"""
...
class SEOAdvisoryAdvisor:
    ...
    VERIFIED_CATALOG: Dict[int, Dict[str, Any]] = {
        390: {
            ...
            "meta": "خرید انگشتر مردانه نقره عیار ۹۲۵ با نگین شجر طبیعی نقش آهو به وزن ۱۳ گرم و رکاب نقره ماشینی در گالری رادمان سیلور. مناسب استفاده روزمره آقایان.",
        ...
        275: {
            ...
            "meta": "خرید انگشتر مردانه نقره عیار ۹۲۵ با نگین عقیق سرخ معدنی ۱۴ میلی‌متر به وزن ۸ گرم و رکاب نقره ماشینی در گالری رادمان سیلور. طراحی ظریف و استاندارد.",
        ...
        232: {
            ...
            "meta": "خرید انگشتر مردانه نقره عیار ۹۲۵ با نگین آماتیست طبیعی تراش دامله به وزن ۸ گرم و رکاب نقره ماشینی در گالری رادمان سیلور. جلوه بنفش و چشم‌نواز.",
        ...
        205: {
            ...
            "meta": "خرید انگشتر مردانه نقره عیار ۹۲۵ با نگین عقیق باباقوری به وزن ۸ گرم و رکاب نقره ماشینی در گالری رادمان سیلور. نگین با الگوی لایه‌بندی کلاسیک.",
        ...
        137: {
            ...
            "meta": "خرید انگشتر مردانه نقره عیار ۹۲۵ با نگین عقیق زرد فرم چهارگوش به وزن ۸ گرم و رکاب نقره ماشینی در گالری رادمان سیلور. طراحی هندسی و متوازن.",
    ...
    def analyze_product(self, product_id: int) -> SEOAdvisoryReport:
        ...
        # Content safety scan against unverified claims and price-in-meta
        content_res = RadmanBusinessRules.validate_content(meta_desc, is_meta_description=True)
    ...
    def generate_markdown_summary(self, reports: List[SEOAdvisoryReport]) -> str:
        ...
        lines = [
            ...
            "> **سیاست قیمت در متادیسکریپشن:** ممنوع (قیمت فقط در اسکیما نگهداری می‌شود)  ",
            "",
            "---",
            "",
            "## ۱. جدول خلاصه پیشنهادهای بهینه‌سازی سئو (بدون قیمت در متا / بدون صفت غیرمستند)",
            "",
            "| شناسه | کد کالا (SKU) | عنوان سئوی پیشنهادی (حداکثر ۶۰ کاراکتر) | طول عنوان | کلمه کلیدی اصلی | طول متا (۱۲۰–۱۵۵) | قیمت اسکیما (تومان) | وزن تأییدشده | وضعیت بررسی |",
            "| :---: | :---: | :--- | :---: | :--- | :---: | :---: | :---: | :---: |",
        ]
        ...
        for rep in reports:
            ...
            lines.extend([
                ...
                f"- **اسکیما استاندار (Schema.org):** نوع Product و Offer با واحد پولی IRT و قیمت دقیق {rep.price_toman:,} تومان در اسکیما (فاقد قیمت در متادیسکریپشن و فاقد قیمت حراجی).",
                "",
            ])
        ...
        lines.extend([
            ...
            "2. **حذف قطعی قیمت از متادیسکریپشن:** قیمت‌ها منحصراً در اسکیما Product/Offer ثبت شده و از متن متادیسکریپشن حذف گردیدند تا دچار کهنگی در ایندکس گوگل نشوند.",
            "3. **قفل کامل حقیقت کالا (Fact-Lock):** تمام ادعاهای غیرمستند (نظیر دست‌ساز، شناسنامه، بسته‌بندی هدیه، گارانتی، نرخ مصوب، و کلمه طبیعی برای سنگ‌های فاقد این فیلد) فیلتر شدند.",
            "",
        ])
