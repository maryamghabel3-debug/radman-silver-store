"""
RADMAN Content Advisory Engine (Phase 2 Content Pilot — Approved Final Polish)
==============================================================================
...
- Owner-approved final polished captions
...
class ContentAdvisor:
    ...
    # Authoritative verified catalog with owner-approved final polished captions
    CATALOG_KNOWLEDGE: Dict[int, Dict[str, Any]] = {
        232: {
            ...
            "price_toman": 6633000,
            "band": "نقره ماشینی",
            "caption": "درخشش نگین آماتیست طبیعی با تراش دامله روی رکاب نقره عیار ۹۲۵، ترکیبی چشم‌نواز و متعادل ساخته است. این انگشتر با وزن ۸ گرم، برای استایل روزمره و رسمی آقایان انتخابی خوش‌فرم و متمایز است.\n\n#نقره_۹۲۵ #انگشتر_مردانه #آماتیست #رادمان_سیلور",
        ...
        205: {
            ...
            "price_toman": 8871000,
            "band": "نقره ماشینی",
            "caption": "عقیق باباقوری با لایه‌بندی طبیعی و ظاهر کلاسیک، روی رکاب نقره عیار ۹۲۵ جلوه‌ای اصیل پیدا کرده است. این مدل با وزن ۸ گرم، برای علاقه‌مندان به سنگ‌های خانواده عقیق گزینه‌ای خوش‌ساخت و باوقار است.\n\n#نقره_۹۲۵ #انگشتر_مردانه #عقیق_باباقوری #رادمان_سیلور",
        ...
        378: {
            ...
            "price_toman": 8100000,
            "band": "نقره ماشینی",
            "caption": "سنگ عقیق سیاه با حکاکی حسبی الله، در کنار رکاب نقره عیار ۹۲۵، جلوه‌ای جدی و متمایز به این انگشتر بخشیده است. این مدل با وزن ۱۲ گرم، انتخابی چشم‌نواز برای آقایانی است که به طرح‌های معنادار علاقه دارند.\n\n#نقره_۹۲۵ #انگشتر_مردانه #عقیق_سیاه #حسبی_الله #رادمان_سیلور",
        ...
        375: {
            ...
            "price_toman": 8100000,
            "band": "نقره ماشینی",
            "caption": "رنگ خاص عقیق سوسنی در کنار نقش رزق و روزی، ترکیبی متفاوت و خوش‌دید روی رکاب نقره عیار ۹۲۵ ساخته است. این انگشتر ۱۲ گرمی، حال‌وهوای خوشنویسانه و سنتی را با فرم مردانه پیوند می‌دهد.\n\n#نقره_۹۲۵ #انگشتر_مردانه #عقیق_سوسنی #رادمان_سیلور",
        ...
        372: {
            ...
            "band": "نقره ماشینی",
            "caption": "شفافیت دُر نجف روی رکاب نقره عیار ۹۲۵، ظاهر این انگشتر را روشن، ساده و در عین حال فاخر کرده است. این مدل با وزن ۱۲ گرم، برای کسانی مناسب است که به سنگ‌های شفاف و فرم‌های کلاسیک علاقه دارند.\n\n#نقره_۹۲۵ #انگشتر_مردانه #در_نجف #رادمان_سیلور",
        ...
        369: {
            ...
            "price_toman": 8100000,
            "band": "نقره ماشینی",
            "caption": "عقیق زرد با حکاکی یا اباعبدالله، در کنار رکاب نقره عیار ۹۲۵، جلوه‌ای شاخص و سنتی به این انگشتر داده است. این مدل ۱۲ گرمی برای آقایانی مناسب است که به رنگ‌های گرم و نقش‌های مذهبی علاقه دارند.\n\n#نقره_۹۲۵ #انگشتر_مردانه #عقیق_زرد #رادمان_سیلور",
    ...
    def generate_markdown_summary(self, reports: List[ContentAdvisoryReport]) -> str:
        lines = [
            "# گزارش تحلیلی عامل تولید محتوا رادمان سیلور (Content Advisory Pilot — Approved Polish)",
            "",
