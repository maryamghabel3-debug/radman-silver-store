# QA Report — Product 384, Angle B (attachment 386)

Pilot `media-image-pipeline-v1-p384-b` — executed 2026-09-03
Source: `media-originals-v1` → `radman-product-images-20260829-052041.zip` → `product-384-sku-17224539-gallery-1-attachment-386.webp`
...
- HAND_SIDE=NA
- STATUS=READY
- NOTES=Removed only the gold "نقره مشهد" seller emblem (bottom-left). Adaptive mask: gold-color detection (r>130, g>90, r-b>45, g-b>20) filtered to lower-left components (y>0.55H, area>400) + loose second pass + 13px dilation + close. Telea inpaint + gentle blur. Ring, box, crop, viewpoint, lighting unchanged elsewhere. Verified side-by-side: clean.
...
- RING_IDENTITY_PRESERVED=YES (same oval milky agate, dark dendrite + green inclusion, beaded bezel, scroll band, left-facing presentation)
- BAND_CLOSED=YES
- HAND_SIDE=NA
- STATUS=READY
...
- RING_IDENTITY_PRESERVED=YES
- BAND_CLOSED=YES
- HAND_SIDE=LEFT (correct for angle B / left-facing ring; thumb at bottom-right = back of a LEFT hand, verified at zoom)
- STATUS=READY
- NOTES=Adult male left hand: 5 fingers, ring worn on ring finger (second from pinky), realistic skin/hairs/knuckles, correct scale, premium charcoal rim-lit framing, no face/text/logo/watermark. No retry (attempt 1/1).
...
- Nothing stored under `media/approved/` for angle B yet. Waiting for owner review.
